  ...
  return (
    <PageTransition>
      <div className="min-h-screen w-full bg-theme-primary text-theme-secondary font-mono relative flex flex-col">
        <GlobalEffects opacity={0.12} showParticles={false} />

        {/* CRT Scanline Overlay */}
        <div className="fixed inset-0 pointer-events-none z-[100] opacity-[0.015] md:opacity-[0.03] bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-[length:100%_2px,3px_100%]" />

        <Header />

        <main className="flex-1 w-full p-2 py-4 md:p-6 lg:p-10 relative z-10">
          <FileExplorer
