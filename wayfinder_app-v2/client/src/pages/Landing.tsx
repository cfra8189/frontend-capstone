      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
        <div className="max-w-md w-full">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full bg-[#333] text-white font-bold py-3 px-8 rounded-lg transition-colors hover:bg-[#444] text-center mb-3"
          >
